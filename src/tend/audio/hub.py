...
VOICE_RULES = (
    ...
    "you are or what you can do (especially 'to the group'), reply with two "
    "or three sentences in plain prose, naming a few concrete capabilities. "
    "Still no lists or markdown. "
